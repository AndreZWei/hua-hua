...
app.use(express.static(__dirname + '/hp/'));
    ...
    if (msg.startsWith('/nick ')){  //add a name
      ...
      if (who === '')
        ...
        if (checkAnswer(msg)) {
          ...
          io.emit("chat message", whoo(whoseTurn)+" is now the painter.");
          io.emit("chat message", "please clear your board by clicking on button 'C' and the game will start when "+whoo(whoseTurn)+" type 'ready'.")
          painterAnnounced = true;
        }
        //new game starts!
