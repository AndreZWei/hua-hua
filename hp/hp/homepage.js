function dropdown(){
  ...
  if (opacity == "0.9") {
    ...
    document.getElementById("nav-icon-open").setAttribute("style", "display:block; opacity:0.9; -moz-opacity:0.9; filter:alpha(opacity=0.9)");
  } else {
    document.getElementById("navmenu").setAttribute("style","display: block; opacity:0.9; -moz-opacity:0.9; filter:alpha(opacity=0.9)");
    document.getElementById("nav-icon-close").setAttribute("style", "display:block; opacity:0.9; -moz-opacity:0.9; filter:alpha(opacity=0.9)");
